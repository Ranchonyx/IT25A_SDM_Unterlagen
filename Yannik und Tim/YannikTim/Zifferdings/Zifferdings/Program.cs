...
namespace Zifferdings
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Write("Geben sie Ihre Prüfzahl ein: ");
            ...
            Console.WriteLine("Die Zahl lautet: " + randomNumber);

            int checkDigit = CalculateLuhnCheckDigit(randomNumber.ToString());
            if (checkDigit != Convert.ToInt64(number))
            {
